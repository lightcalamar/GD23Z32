...
#ifndef _GD23Z32_H_INCLUDED
#define _GD23Z32_H_INCLUDED
...
#include <stdarg.h>
#include "SPI.h"
#include "SdFat.h"  //del core gen�rico de danieleff
...
//FT81XMANIA TEAM (@lightcalamar)
  ...
  #define CS D8
#else
  #define CS           PA4 //SPI1  10 T36, 8 gameduino 2/3
#endif
#endif

#if defined(ESP8266)
  #define SD_PIN        D9 //microSD enable signal
#else
  #define SD_PIN      PA15 //SPI3   5 T36, 9 gameduino 2/3

#endif

//FT81XMANIA TEAM (TFTLCDCyg)

#define EEPROM_SOURCE      1  // 0 external, 1 DS3231 ZS-042
...
#define SCREEN_FT81X      13 //12, 13, 10 para 10y11, 14 FT813_5,  15  FT813_43,   16  FT813_35
